...
if load_data:  # This is only for the budget = 500 setting
    ...
    evaluated_set_y_batch = pd.read_csv('Surrogates/Data/y.csv', index_col=0).values
    oos_set = pd.read_csv('Surrogates/Data/X_oos.csv', index_col=0).values
    y_test = pd.read_csv('Surrogates/Data/y_oos.csv', index_col=0).values
else:
